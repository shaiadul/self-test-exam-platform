          ...
          <div className="max-w-md w-full text-center md:text-left">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-12 leading-relaxed">
                Practice your skills, take exams, and achieve your goals with our professional online exam platform. Join over 1,200+ students today.
              </p>

              <div className="flex flex-col gap-4">
                <PrimaryBtn className="w-full h-14 text-lg font-bold hover-lift" link="/auth/login">
                  Sign In to Account
                </PrimaryBtn>
                <div className="relative flex items-center py-4">
                  <div className="flex-grow border-t border-gray-200"></div>
                  <span className="flex-shrink mx-4 text-gray-400 text-sm font-bold uppercase tracking-wider">or</span>
                  <div className="flex-grow border-t border-gray-200"></div>
                </div>
                <OutlineBtn className="w-full h-14 text-lg font-bold border-2 hover-lift" link="/auth/register">
                  Create New Account
                </OutlineBtn>
              </div>
            </motion.div>
