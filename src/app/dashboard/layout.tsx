            ...
            {loading ? (
              ...
              <div className="min-h-[70vh] flex items-center justify-center p-4">
                <div className="bg-white border border-gray-100 rounded-3xl p-10 shadow-xl max-w-lg w-full text-center relative overflow-hidden">
                  ...
                  <h2 className="text-2xl font-black text-gray-900 mb-3 uppercase tracking-wider">Access Restricted</h2>
                  <p className="text-gray-500 text-sm leading-relaxed mb-8">
                    Your account role <span className="font-bold text-[#dd6b01] uppercase">({userRole})</span> is not authorized to access <span className="font-semibold text-gray-700 bg-gray-50 px-2 py-1 rounded border border-gray-100 text-xs break-all">{pathname}</span>. Please verify your credentials or contact the portal administrator if you believe this is an error.
                  </p>
